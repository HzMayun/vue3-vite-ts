      ...
      <el-tab-pane v-for="item in menuList" :key="item.id" :label="item.name" :name="item.url">
        <el-row class="menu-cent">
          <el-col :span="4">
            ...
            >
              <el-sub-menu
                popper-class="qqqqqqqqqqqqqqqqqqqq"
        ...
        <div class="content">
          <button @click="goGoods('/retail/goods-list')">商品列表</button>
          <button @click="goGoods('/retail/goods-mgr/goods-combined')">组合商品</button>
          <router-view />
        </div>
      </el-tab-pane>
    </el-tabs>
